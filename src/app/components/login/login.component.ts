import { CoachMarkModel, Elements, Place } from './../../shared/coachmark/model/coachmark.model';
...
export class LoginComponent implements OnInit {
    ...
    user = 'admin';
    password = 'admin';
    ids: Elements[] = new Array<Elements>();
